...
(function () {
    ...
    const UNIT_LABELS = {
        a1: '🥤 A1 自動飲料販賣機',   a2: '💇 A2 理髮店售票機',
        a3: '🍔 A3 美式速食自助點餐', a4: '🛒 A4 模擬購物',
        a5: '🏧 A5 ATM提款機',        a6: '🚂 A6 火車購票',
        b1: '💰 B1 今天帶多少錢',     b2: '📔 B2 零用錢日記', b3: '🐷 B3 存錢計畫',
        b4: '🏷️ B4 商品價格比較',      b5: '🎉 B5 派對活動採購', b6: '🥬 B6 菜市場買菜',
        b:  '📒 B 系列 預算規劃',
        c1: '🪙 C1 金錢的種類與面額', c2: '🔢 C2 金錢的點數與加總',
        c3: '🔄 C3 金錢面額的兌換',   c4: '💳 C4 正確的金額',
        c5: '✅ C5 足額付款',         c6: '💸 C6 找零與計算',
        c:  '💴 C 系列 金錢認知',
        f1: '1️⃣ F1 數量與物品的對應', f2: '🎵 F2 數量與點數',
        f3: '🔢 F3 認識數字與數量',   f4: '📊 F4 數字排序',
        f5: '⚖️ F5 數量大小的比較',  f6: '🧩 F6 數的合成與分解',
        f:  '🔢 F 系列 數學基礎',
    };
