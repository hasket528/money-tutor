    ...
    DATA: {
        ...
        SAFETY: [
            ...
            { icon:'🛒', tag:'代購先付款', hint:'不先付全額給陌生人', safeSpeak:'不認識的代購，不要先付全額！',
              scene: n => `網路上有人說能幫${n}代購限量球鞋，但要先付全額三千元，貨才會寄。`,
              question:'這時候應該怎麼做？',
              options:[
            ...
            { icon:'🎣', tag:'免費點數陷阱', hint:'天下沒有白吃的午餐', safeSpeak:'免費送點數要你先付錢，是騙人的！',
              scene: n => `${n}看到廣告：「填問卷免費送遊戲點數！只要先付六十元運費。」`,
              question:'這時候應該怎麼做？',
              options:[
            ...
            { icon:'📈', tag:'穩賺是騙局', hint:'保證獲利都是假', safeSpeak:'保證穩賺的投資，一定是騙局！',
              scene: n => `網友跟${n}說：「跟我投資虛擬貨幣，一週保證賺一倍，穩賺不賠！」`,
              question:'這時候應該怎麼做？',
              options:[
            ...
            { icon:'🔒', tag:'私訊借帳號', hint:'帳號不外借', safeSpeak:'再好的朋友，帳號也不能外借！',
              scene: n => `${n}收到好友私訊：「我手機壞了，借你的遊戲帳號登入一下，急！」`,
              question:'這時候應該怎麼做？',
              options:[
            ...
            { icon:'🎁', tag:'抽獎要運費', hint:'中獎不必先付錢', safeSpeak:'中獎還要你先付錢，就是詐騙！',
              scene: n => `${n}收到通知：「恭喜抽中最新手機！請先付八百元運費和稅金來領取。」`,
              question:'這時候應該怎麼做？',
              options:[
            ...
            { icon:'💵', tag:'高薪先繳費', hint:'正當工作不先收費', safeSpeak:'工作要你先繳費買材料，是陷阱！',
              scene: n => `打工廣告寫著：「在家打包賺高薪！需先繳三千元購買材料包。」`,
              question:'這時候應該怎麼做？',
              options:[
            ...
            { icon:'🤝', tag:'二手先確認', hint:'面交驗貨再付款', safeSpeak:'網路二手交易，驗到貨再付錢！',
              scene: n => `${n}想買二手手機，賣家說：「你先匯款，我明天就寄，不然不賣了。」`,
              question:'這時候應該怎麼做？',
              options:[
            ...
            { icon:'🍔', tag:'AA制講清楚', hint:'分攤要算清楚', safeSpeak:'一起吃飯，費用要平均分攤算清楚！',
              scene: n => `和同學聚餐共花四百元，四個人平分，輪到${n}算錢。`,
              question:'每個人應該付多少？',
              options:[
                { text:'四百除以四，每人一百元',       safe:true,  fb:'平分就是總數除以人數' },
                { text:'每人付四百元',                 safe:false, fb:'那是全部人的總額' },
                { text:'讓別人多付一點',               safe:false, fb:'分攤要公平才行' },
              ] },
            { icon:'🧧', tag:'紅包先存好', hint:'大錢先存不亂花', safeSpeak:'收到大紅包，先存起來不要亂花！',
              scene: n => `過年${n}收到兩千元紅包，同學揪一起去買很多想要的東西。`,
              question:'這時候應該怎麼做？',
              options:[
                { text:'先存起來，需要時再花一部分',   safe:true,  fb:'大錢先存才不會亂花光' },
                { text:'今天全部花光',                 safe:false, fb:'一下就沒了會後悔' },
                { text:'借給同學一起花',               safe:false, fb:'借出去常要不回來' },
              ] },
            { icon:'💸', tag:'不亂點內購', hint:'手遊課金要節制', safeSpeak:'遊戲抽卡要控制預算，不能一直課！',
              scene: n => `手機遊戲跳出：「限時抽卡！再花三百元就可能抽到稀有角色！」`,
              question:'這時候應該怎麼做？',
              options:[
            ...
            { icon:'🎫', tag:'黃牛票有詐', hint:'透過正規管道買', safeSpeak:'私下買票容易被騙，要走正規售票！',
              scene: n => `網友說能便宜賣${n}演唱會門票，但要先付款且不能面交。`,
              question:'這時候應該怎麼做？',
              options:[
            ...
            { icon:'🎮', tag:'遊戲交易詐騙', hint:'虛寶交易要小心', safeSpeak:'遊戲寶物交易，先收到錢再給東西！',
              scene: n => `有人想買${n}的遊戲寶物，說：「你先把寶物給我，我馬上轉錢給你。」`,
              question:'這時候應該怎麼做？',
              options:[
            ...
            { icon:'🛡️', tag:'個資不亂填', hint:'網站個資要保護', safeSpeak:'來路不明的網站，不要填個人資料！',
              scene: n => `一個陌生網站要${n}填姓名、電話、地址才能「查看成績」。`,
              question:'這時候應該怎麼做？',
              options:[
