...
const SCENARIO_CLERK_MAP = {
  ...
  job_scam:          { keyword: '云枫', name: '可疑老闆', role: '打工應徵', image: 'images/clerk-jobscam.jpg', intro: '這裡練習找打工時怎麼保護自己——要你先繳保證金、押證件、太好賺的工作。記住三不：不先繳錢、不押證件、不借帳戶！' },
  privacy_protect:   { keyword: '云希', name: '資安小老師', role: '個資保護', image: 'images/clerk-privacy.jpg', intro: '這裡練習保護個人資料——驗證碼不唸給別人、問卷個資不亂填、帳號密碼不外借。記住：個資就像家裡的鑰匙，不能隨便交出去！' },
  take_bus:          { keyword: '云扬', name: '公車司機', role: '公車', image: 'images/clerk-takebus.jpg', intro: '你好！我是公車司機。這裡練習搭公車——先確認路線、上車刷卡或投現，零錢不夠、坐過站的時候怎麼開口求助。' },
  mrt_station:       { keyword: '云健', name: '捷運站務員', role: '捷運站', image: 'images/clerk-mrtstaff.jpg', intro: '你好！我是捷運站務員。這裡練習搭捷運——不會買票請人教、卡片刷不過去要加值、搭錯方向怎麼問。有問題找站務員就對了！' },
  train_ticket:      { keyword: '晓涵', name: '售票員', role: '火車站售票口', image: 'images/clerk-trainticket.jpg', intro: '你好！我是火車站售票員。這裡練習到售票口買票——說清楚目的地和車種、付錢確認找零、問月台，還有趕不上車、車票不見時怎麼辦。' },
  taxi:              { keyword: '雲哲', name: '計程車司機', role: '計程車', image: 'images/clerk-taxi.jpg', intro: '你好！我是計程車司機。這裡練習搭計程車——上車前先問價錢確認預算、說清楚目的地、下車付錢確認找零，不舒服也要開口說。' },
  easycard_service:  { keyword: '晓梦', name: '服務台人員', role: '悠遊卡服務台', image: 'images/clerk-easycard.jpg', intro: '你好！這裡是悠遊卡服務台。練習加值後確認餘額、卡片掉了趕快掛失、辦學生卡要帶什麼——卡片裡的錢也要好好保護喔！' },
  ...
  cinema:            { keyword: '晓辰', name: '電影院店員', role: '電影院', image: 'images/clerk-cinema.jpg', intro: '你好！我是電影院店員。這裡練習買電影票——選場次、用學生證買優惠票、加購前想想預算，遲到了也知道怎麼辦。' },
  ktv:               { keyword: '晓睿', name: 'KTV店員', role: 'KTV', image: 'images/clerk-ktv.jpg', intro: '歡迎來 KTV！這裡練習問清楚計費、算總價大家分攤、時間到照預算收手，點歌機不會用就請人教。' },
  ...
  amusement_park:    { keyword: '晓伊', name: '遊樂園工作人員', role: '遊樂園', image: 'images/clerk-park.jpg', intro: '歡迎來遊樂園！這裡練習算一算哪種票划算、問設施安全限制，還有和朋友走散時找工作人員、在原地等。' },
  arcade:            { keyword: '曉臻', name: '遊樂場店員', role: '電子遊樂場', image: 'images/clerk-arcade.jpg', intro: '歡迎光臨！這裡練習換代幣控制預算、夾娃娃先設上限說到做到，機台吃錢不拍不踢找店員——玩得開心也要守住錢包！' },
  comic_store:       { keyword: '云野', name: '漫畫店店員', role: '漫畫店', image: 'images/clerk-comic.jpg', intro: '歡迎光臨漫畫店！這裡練習租書認識押金和逾期費、遲還了誠實道歉，還有分辨辦會員留哪些資料合理、哪些絕對不能給。' },
  job_interview:     { keyword: '云泽', name: '店長', role: '打工面試', image: 'images/clerk-jobinterview.jpg', intro: '你好！我是店長。這裡練習打工面試——自我介紹、誠實回答問題，還有問清楚時薪和發薪日；遇到要先繳錢的，記得先回家問大人！' },
